...
Partial Class _Default
    ...
    Protected Sub performTask_Click(sender As Object, e As System.EventArgs) Handles performTask.Click
        ...
        Dim P As Decimal = principleamount.Text
        Dim r As Decimal = interestRate.Text
